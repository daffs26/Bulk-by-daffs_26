  ...
  return (
    <View style={{ flex: 1, backgroundColor: BG, padding: 18 }}>
      ...
      >
        ...
        >
          1,247 <Text style={{ fontSize: 12, color: DIM }}>kcal</Text>
        </Text>
        <View
          style={{
            height: 3,
        ...
        <Text style={{ color: DIM, fontSize: 7.5, marginTop: 8 }}>
          Target harian: 2,000 kcal · Sisa 753 kcal
        </Text>
      </View>
      ...
      <View style={{ flexDirection: "row", gap: 6, marginBottom: 12 }}>
        {[
          ...
          >
            <Text
              style={{ color, fontSize: 11, fontFamily: "Poppins_700Bold" }}
            >
              {val}
            </Text>
            <Text
      ...
      {foods.map((f, i) => (
        ...
        >
          <View>
            ...
            <Text style={{ color: DIM, fontSize: 7.5, marginTop: 2 }}>
              {f.qty}
            </Text>
          </View>
          <Text
            style={{ color: O, fontSize: 11, fontFamily: "Poppins_700Bold" }}
          >
            +{f.cal} <Text style={{ fontSize: 7, color: MUTED }}>kcal</Text>
          </Text>
        </View>
      ))}
    ...
    <View style={{ flex: 1, backgroundColor: BG, padding: 18 }}>
      ...
      <View style={{ flexDirection: "row", gap: 8 }}>
        ...
        >
          ...
          <Text
            style={{ color: TXT, fontSize: 14, fontFamily: "Poppins_700Bold" }}
          >
            68.2 kg
          </Text>
          <Text style={{ color: "#10B981", fontSize: 8, marginTop: 2 }}>
            -1.8 kg bulan ini
          </Text>
        </View>
        <View
        ...
        >
          ...
          <Text
            style={{ color: O, fontSize: 14, fontFamily: "Poppins_700Bold" }}
          >
            12 HARI
          </Text>
          <Text style={{ color: DIM, fontSize: 8, marginTop: 2 }}>
            Konsisten log
          </Text>
        </View>
      </View>
    ...
    <View
      style={[
        ...
        Platform.select({
          web: {
            boxShadow:
              "0 40px 90px rgba(0,0,0,0.85), 0 0 0 1px rgba(255,255,255,0.06), inset 0 0 0 1px rgba(255,255,255,0.02)",
          },
        }) as any,
      ]}
    >
...
const FEATURES = [
  {
    ...
    tag: "SCAN",
    desc: "Identifikasi makanan instan dengan visual recognition langsung dari perangkat.",
  },
  {
    id: "02",
    title: "Private Local Storage",
    tag: "DATA",
    desc: "100% data tersimpan lokal. Tidak ada sinkronisasi cloud eksternal jika tidak diinginkan.",
  },
  {
    id: "03",
    title: "UPC Barcode Decoder",
    tag: "SCAN",
    desc: "Scan kode makanan kemasan secara cepat dengan kamera internal.",
  },
  {
    id: "04",
    title: "Dynamic Target Calculator",
    tag: "CORE",
    desc: "Estimasi BMI dan TDEE terintegrasi untuk kalkulasi target kalori ideal.",
  },
];
  ...
  return (
    ...
    >
      ...
      <View
        style={[
          s.header,
          isMobile && { paddingHorizontal: 20, paddingVertical: 16 },
        ]}
      >
      ...
      >
        ...
        <View style={[s.heroMain, isMobile && { flex: undefined }]}>
          ...
          <Text
            style={[
              s.mainSubhead,
              isMobile && { fontSize: 13, lineHeight: 20, marginBottom: 20 },
            ]}
          >
            Sistem pelacakan kalori mandiri dengan asisten kecerdasan buatan.
            Berjalan sepenuhnya di peramban, bebas pelacakan data, dan dapat
            dioperasikan secara luring setelah proses instalasi.
          </Text>
          ...
          <View style={[s.installTerminal, isMobile && { marginBottom: 20 }]}>
            <View style={s.terminalHeader}>
              <View style={s.terminalButtons}>
                <View
                  style={[s.terminalBtnCircle, { backgroundColor: "#FF5F56" }]}
                />
                <View
                  style={[s.terminalBtnCircle, { backgroundColor: "#FFBD2E" }]}
                />
                <View
                  style={[s.terminalBtnCircle, { backgroundColor: "#27C93F" }]}
                />
              </View>
      ...
      >
        <View style={[s.featLeftPane, isMobile && { flex: undefined }]}>
          ...
          <Text style={s.featSectionDesc}>
            BULK dirancang khusus untuk mempermudah perjalanan kebugaran Anda.
            Pantau asupan kalori, hitung keseimbangan nutrisi harian, dan raih
            target tubuh ideal Anda dengan bantuan kecerdasan buatan yang instan
            dan mudah digunakan.
          </Text>
        </View>
